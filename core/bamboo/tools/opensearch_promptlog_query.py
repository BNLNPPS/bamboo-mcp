    ...
    def get_definition() -> dict[str, Any]:
        ...
        return {
            ...
            "description": (
                ...
                "omitted by default)\n"
                "  NOTE: there is no user_id field — this system is single-user. "
                "  session_id identifies a server process lifetime, not a person. "
                "  Do not attempt to aggregate by user; aggregate by session_id "
                "  or model instead.\n\n"
