...
Covers :mod:`askcgsim.doc_rag`, :mod:`askcgsim.doc_bm25`, and
:mod:`askcgsim.ui_manifest`.
...
class TestCgsimDocSearchTool:
    """Tests for :class:`askcgsim.doc_rag.CgsimDocSearchTool`."""

    def test_get_definition_shape(self) -> None:
        """get_definition returns a valid MCP tool definition."""
        from askcgsim.doc_rag import CgsimDocSearchTool
    ...
    def test_module_singleton_exists(self) -> None:
        ...
        from askcgsim.doc_rag import cgsim_doc_search_tool, CgsimDocSearchTool
...
class TestCgsimDocBM25Tool:
    """Tests for :class:`askcgsim.doc_bm25.CgsimDocBM25Tool`."""

    def test_get_definition_shape(self) -> None:
        """get_definition returns a valid MCP tool definition."""
        from askcgsim.doc_bm25 import CgsimDocBM25Tool
    ...
    def test_module_singleton_exists(self) -> None:
        ...
        from askcgsim.doc_bm25 import cgsim_doc_bm25_tool, CgsimDocBM25Tool
...
class TestCgsimUiManifestTool:
    """Tests for :class:`askcgsim.ui_manifest.CgsimUiManifestTool`."""

    def test_get_definition_shape(self) -> None:
        """get_definition returns the expected MCP tool definition."""
        from askcgsim.ui_manifest import CgsimUiManifestTool
    ...
    def test_module_singleton_exists(self) -> None:
        ...
        from askcgsim.ui_manifest import cgsim_ui_manifest_tool, CgsimUiManifestTool
